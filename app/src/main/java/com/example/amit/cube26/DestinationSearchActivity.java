 ...
 */
public class DestinationSearchActivity  extends ActionBarActivity implements LoaderManager.LoaderCallbacks<Cursor>{
...
//                if (cursor != null) {
//                    ((Callback)this)
//                            .onItemSelected(FaasosDBContract.TrainEntry.buildFaasosDetail(
...
//                editor.putString("DESTINATION", cursor.getString(1));
//                editor.commit();
